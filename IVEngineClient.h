...
public:
	...
	virtual bool				GetPlayerInfo(int ent_num, player_info_t *pinfo) = 0; //index 8 in this vtable
	...
	virtual void				GetViewAngles(QAngle& va) = 0; //index 19 in this vtable
