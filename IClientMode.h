...
public:
	...
	virtual void __pad1() = 0; // *GetViewport() = 0;

	// Gets at the viewports vgui panel animation controller, if there is one...
	virtual void __pad2() = 0;//vgui::AnimationController *GetViewportAnimationController() = 0;
	...
	virtual void __pad3() = 0; //vgui::Panel *GetMessagePanel() = 0;
	...
	virtual void	__pad4() = 0; //ActivateInGameVGuiContext(vgui::Panel *pPanel) = 0;
