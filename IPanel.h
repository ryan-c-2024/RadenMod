...
namespace vgui
{
	...
	public:
		...
		virtual void GetInset(VPANEL vguiPanel, int &left, int &top, int &right, int &bottom) = 0; //index 12
		...
		virtual void __pad1() = 0;//CUtlVector< VPANEL > &GetChildren(VPANEL vguiPanel) = 0;
		...
		virtual bool IsFullyVisible(VPANEL vguiPanel) = 0; //25

		// gets the scheme this panel uses
		virtual void __pad2() = 0;		//virtual HScheme GetScheme(VPANEL vguiPanel) = 0;
		...
		virtual const char *GetName(VPANEL vguiPanel) = 0; //	>>in this vtable it is index 35 and it works<<
		...
		// sibling pins
		virtual void __pad3() = 0;//virtual void SetSiblingPin(VPANEL vguiPanel, VPANEL newSibling, byte iMyCornerToPin = 0, byte iSiblingCornerToPinTo = 0) = 0;
